...
export class Car extends BuildableLego {
    constructor(rootLocation = vec3(0, 18, 0), scale = vec3(1, 1, 1)) {
        ...
        this.shapes = {
            ...
            stud: new defs.Shape_From_File("lego_models/car_pieces/stud/stud.obj"),
            tire: new defs.Shape_From_File("lego_models/car_pieces/tire/tire.obj"),
            topBack: new defs.Shape_From_File("lego_models/car_pieces/topBack/topBack.obj"),
